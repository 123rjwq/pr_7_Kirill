abstract class PizzaCity (
    ...
    // Свойства, представляющие количество проданных пицц разных видов, отображение чеков и другую статистику продаж
    ...
    var totalSauceRevenue = 0.0
        internal set
    // Абстрактные функции, которые должны быть реализованы в подклассах
    abstract fun neapolitanPizzaSale()
    abstract fun romanPizzaSale()
    abstract fun sicilianPizzaSale()
    abstract fun tyroleanPizzaSale()
    abstract fun offerSauce()
    // Функция для вывода общих статистических данных
    open fun showStatistics() {
        // Вывод статистики по продажам пиццы, напитков, соусов и другим показателям
...
// Вспомогательная функция для вычисления процентного соотношения
